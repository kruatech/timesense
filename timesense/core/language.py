...
угадывается — возвращается fallback ("ru"). Чтобы такие фразы разбирались
по-английски, задайте TimeConfig(default_language="en") или parse(..., language="en").
Смешанный текст → побеждает больший счёт, при равенстве fallback.
"""
